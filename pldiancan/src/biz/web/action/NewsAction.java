...
public class NewsAction extends BaseAction implements ModelDriven<News> {
	...
	private int uid;
	private News bean = new News();

	@Action(value = "add2News", results = { @Result(name = "add2", location = "/WEB-INF/jsp/sys/addNews.jsp") })
	public String add2() {
		return "add2";
	}

	@Action(value = "getNews", results = { @Result(name = "getOne", location = "/WEB-INF/jsp/sys/modifyNews.jsp") })
	public String get() {
		try {
			News temp = (News) service.get(News.class, uid);
	...
	@Action(value = "queryNews", results = { @Result(name = "queryList", location = "/WEB-INF/jsp/sys/listNews.jsp") })
	public String query() {
		try {
			int pageNum = 0;
