...
public class Apriori {
	private int SUPPORT = 2; // 支持度阈值
	private double CONFIDENCE = 0.7; // 置信度阈值
	 ...
	 * 
	 *         参考：http://blog.163.com/xiaohui_1123@126/blog/static/3980524020109784356915/ 思路：假设集合S（A,B,C,D），其大小为4，拥有2的4次方个子集，即0-15，二进制表示为0000，0001，...，1111。 对应的子集为空集，{D}，...，{A,B,C,D}。
	 */
