...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<span  onclick="javascript:location.href='${ctx}/com/index.action'" style="line-height:normal; color:white;font-size: 30px;font-weight: bold;margin-left: 210px;margin-top: 120px;text-align:center;">
				${appTitle }</span>
				<ul class="nav">
					<li  >${SESSION_BEAN.user.user.userName} | <a href="${ctx }/com/logout.action">退出</a></li>
				</ul>
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
						 <c:if test="${SESSION_BEAN.role=='SysUser' }">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/querySimpleUser.action" target="navTab" rel="mainquery">用户管理</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryGoodsType.action" target="navTab" rel="mainquery">商品类型管理</a></li>
									 <li><a href="${ctx}/sys/queryGoods.action" target="navTab" rel="mainquery">商品管理</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryUserOrder.action" target="navTab" rel="mainquery">订单管理</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
								<h2><span>Folder</span>关联推荐</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryRecommend.action" target="navTab" rel="mainquery">关联推荐</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryNews.action" target="navTab" rel="mainquery">新闻列表</a></li>
								</ul>
							</div>
							<div class="accordionHeader">
								<h2><span>Folder</span>友情连接</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryLink.action" target="navTab" rel="mainquery">友情连接列表</a></li>
								</ul>
							</div>
						</c:if>
						 <c:if test="${SESSION_BEAN.role=='SimpleUser' }">
							...
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryMyOrder.action" target="navTab" rel="mainquery">我的订单</a></li>
								</ul>
							</div>
						</c:if>
						<div class="accordionHeader">
								<h2><span>Folder</span>个人信息</h2>
							</div>
						<div class="accordionContent">
							<ul class="tree treeFolder">
								 <li><a href="${ctx}/com/toSelf.action" target="navTab" rel="mainquery">个人信息</a></li>
							</ul>
						</div>
			...
			<div id="navTab" class="tabsPage">
				<div class="tabsPageHeader">
					<div class="tabsPageHeaderContent">
						<ul class="navTab-tab">
							<li tabid="main" class="main"><a href="javascript:;"><span><span class="home_icon">欢迎您</span></span></a></li>
						</ul>
					</div>
