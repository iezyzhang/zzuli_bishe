...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<body background="">
			...
			<div class="container" style="width: 500px;">
				<form action="${pageContext.request.contextPath }/com/reg.action" method="post" id="login" name="login">
					<h3 style="color: #802C59" align="center">用户注册</h3>
					<div class="control-group">
						<label style="font-size:18px;">登录账号:</label>
						<input type="text" name="regbean.user.uname" id="username" value="" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入您的登录账号" data-placement="right"/>
					</div>
					<div class="control-group">
						<label style="font-size:18px;">姓名:</label>
						<input type="text" name="regbean.user.userName" id="username" value="" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入您的姓名" data-placement="right"/>
					</div>
					
					<div class="control-group">
						<label style="font-size:18px">登录密码:</label>
						<input type="password" name="regbean.user.userPassword" id="password" value="" style="width: 283px;" maxlength="30" rel="tooltip" data-original-title="请输入您的登录密码" data-placement="right"/>
					</div>
					<div class="control-group">
						<label style="font-size:18px">性别:</label>
							<select name="regbean.user.userGender">
					...
					<div class="control-group">
						...
						<input type="text" name="regbean.user.userPhone"   value="" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入您的联系电话" data-placement="right"/>
					</div>
					<div class="control-group">
						<label style="font-size:18px;">电子邮箱:</label>
						<input type="text" name="regbean.user.userEmail"   value="" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入您的电子邮箱" data-placement="right"/>
					</div>
					<div class="control-group">
						<label style="font-size:18px;">联系地址:</label>
						<input type="text" name="regbean.user.userAddress"   value="" style=" width: 283px;" maxlength="14" rel="tooltip" data-original-title="请输入联系地址" data-placement="right"/>
					</div>
					...
					window.location="./index.jsp";
						...
						<div align="left" style="width:100%; border-top:1px #CCC solid; margin-top:10px;">
							<table style="width:100%;">
								<tr>
									<td align="left">Copyright &copy; 2015  管理系统</td>
								</tr>
							</table>
						</div>
